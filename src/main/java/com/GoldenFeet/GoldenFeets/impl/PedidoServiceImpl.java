...
public class PedidoServiceImpl implements PedidoService {
    ...
    public Venta crearPedido(PedidoRequestDTO pedidoRequest) {
        ...
        // 💥 CORRECCIÓN FINAL DEL MAPA: Usamos Producto::getId, que devuelve Long,
        // para asegurarnos de que el mapa sea Map<Long, Producto>
        Map<Integer, Producto> productosMap = productoRepository.findAllById(productoIdsLong).stream()
        ...
        for (var itemDTO : pedidoRequest.getItems()) {
            ...
            // Usamos Long para buscar en el mapa (clave es Long)
